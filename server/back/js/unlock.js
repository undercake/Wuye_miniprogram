...
(function($) {
    ...
    Slider.prototype = {
        create: function() {
            ...
            function initDOM() {
                var template = '<div class="slide-to-unlock-bg"><span>' +
                    options.text +
                    '</span></div><div class="slide-to-unlock-progress"></div><div id="unlockSlideHandle" class="slide-to-unlock-handle unlock-handle"></div>';
        ...
        bindDragEvent: function() {
            ...
            let prog = container.getElementsByClassName('slide-to-unlock-progress')[0];
            let bg = container.getElementsByClassName('slide-to-unlock-bg')[0];
            let handle = container.getElementsByClassName('slide-to-unlock-handle')[0];
            ...
            function mousemoveHandler(event) {
                var moveX = event.clientX || event.touches[0].clientX;

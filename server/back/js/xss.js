...
function getDefaultWhiteList () {
  ...
  whiteList['flood-color'] = true; // default: black
  whiteList['flood-opacity'] = true; // default: 1
  whiteList['flow-from'] = true; // default: none
  whiteList['flow-into'] = true; // default: none
